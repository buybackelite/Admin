        ...
        {status === 'success' && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full py-3 gradient-admin text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-emerald-500/25 flex items-center justify-center gap-2"
            >
